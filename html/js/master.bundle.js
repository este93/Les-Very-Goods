...
var _hrl = __webpack_require__(/*! ./inc/hrl.js */ "./src/js/common/inc/hrl.js");

Object.defineProperty(exports, 'hrl', {
  enumerable: true,
  get: function get() {
    return _hrl.hrl;
  }
...
var _stats = __webpack_require__(/*! ./inc/stats.js */ "./src/js/common/inc/stats.js");
...
var _defer = __webpack_require__(/*! ./inc/defer.js */ "./src/js/common/inc/defer.js");

Object.defineProperty(exports, 'WB', {
  enumerable: true,
  get: function get() {
    return _defer.WB;
  }
...
var hrl = exports.hrl = function hrl() {
    initHrl();
            ...
            submenuToggle[i].onclick = function (e) {
                ...
                if (!this.classList.contains('active')) {
                    ...
                    try {
                        ...
                        for (var _iterator = submenuToggle[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var el = _step.value;
                    ...
                    try {
                        for (var _iterator2 = submenu[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var _common = __webpack_require__(/*! ./js/common/common.js */ "./src/js/common/common.js");

var _header = __webpack_require__(/*! ./js/header.js */ "./src/js/header.js");
...
window.WB = _common.WB;
window.stats = _common.stats;
